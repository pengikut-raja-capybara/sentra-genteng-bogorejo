...
export const heroContent: HeroContent = {
  eyebrow: 'Produsen Genteng Terintegrasi',
  title:
    'Pusat Produksi Genteng Berkualitas Bogorejo, Magetan - Pasokan Langsung untuk Kontraktor dan Pemborong',
  subtitle:
    'Menyatukan dedikasi ratusan pengrajin dalam satu entitas berskala pabrik. Dapatkan harga langsung dari produsen tanpa perantara.',
...
export const valuePropositions: ValuePropositionItem[] = [
  {
    ...
    description:
      'Bernegosiasi langsung dengan perwakilan desa untuk memutus rantai makelar tradisional dan mendapatkan margin harga terbaik bagi kedua belah pihak.',
  },
  {
    title: 'Kemandirian Rantai Pasok',
    description:
      'Setiap pemesanan mendukung kemandirian ekonomi pengrajin lokal sekaligus memperkuat kapasitas distribusi material konstruksi dari desa ke proyek Anda.',
  },
]
